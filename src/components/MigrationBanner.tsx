...
export function MigrationBanner() {
  ...
  return (
    <div className="flex flex-col items-start gap-3 border-b border-amber/30 bg-amber/10 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 md:px-8">
      <div>
